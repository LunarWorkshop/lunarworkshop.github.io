...
Returns `true` if **Left** is strictly greater than **Right**. Use this to test whether a value has exceeded a threshold â€” for example whether an elapsed time has passed a deadline or a health value has risen above a recovery threshold.
