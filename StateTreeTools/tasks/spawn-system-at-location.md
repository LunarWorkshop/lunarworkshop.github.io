...
### UE 5.6 and later
- Task completes asynchronously the instant the Niagara system finishes â€” no per-frame tick is needed.
...
[â† Back to Niagara](/StateTreeTools/tasks/niagara) Â· [â† Back to home](/StateTreeTools/)
