...
Draws a 2D donut (annulus) shape â€” two concentric circles connected by radial lines â€” oriented by a transformation matrix. When **While Task Is Active** is enabled the donut is redrawn every tick. When disabled it is drawn once on enter and the task immediately succeeds.
