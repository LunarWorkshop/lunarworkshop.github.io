...
Plays a spatialized sound at a world-space location when the state is entered. The task fires once and immediately succeeds â€” it does not wait for the sound to finish. Use [Spawn Sound At Location](/StateTreeTools/tasks/spawn-sound-at-location) instead if you need to track playback or hold a reference to the audio component.
